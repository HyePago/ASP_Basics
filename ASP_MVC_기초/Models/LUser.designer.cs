...
namespace ASP_MVC_기초.Models
{
    ...
    partial void DeleteTUser3209(TUser3209 instance);
		...
		public System.Data.Linq.Table<TUser3209> TUser3209
		{
			get
			{
				return this.GetTable<TUser3209>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TUser3209")]
	public partial class TUser3209 : INotifyPropertyChanging, INotifyPropertyChanged
	{
